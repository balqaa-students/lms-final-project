        ...
        <div class="container eduvibe-animated-shape">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                    <div class="edu-footer-widget">
                        <div class="logo">
                            <a href="index.html">
                                <img class="logo-light" src="{{ asset('Front/assets/images/logo/logo-white.png')}}" alt="Site Logo">
                            </a>
                        </div>
            ...
            <div class="shape-dot-wrapper shape-wrapper d-md-block d-none">
                <div class="shape-image shape-image-1">
                    <img src="{{ asset('Front/assets/images/shapes/shape-21-01.png')}}" alt="Shape Thumb" />
                </div>
                <div class="shape-image shape-image-2">
                    <img src="{{ asset('Front/assets/images/shapes/shape-35.png')}}" alt="Shape Thumb" />
                </div>
            </div>
        </div>
    </div>
